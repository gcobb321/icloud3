...
from ..apple_acct.pyicloud_ic3 import (PyiCloudValidateAppleAcct, PyiCloudService,
...
def is_authentication_2fa_code_needed(PyiCloud, initial_setup=False):
    ...
    if new_2fa_authentication_code_requested(PyiCloud, initial_setup):
        ...
        if PyiCloud.new_2fa_code_already_requested_flag is False:
            ...
            try:
                # Gb.config_entry.async_start_reauth(Gb.hass)
                # Gb.hass.async_add_executor_job(Gb.config_entry.async_start_reauth, Gb.hass)
