...
class GlobalVariables(object):
    ...
    # starting without an actual error.
    # Set this to True, then select 'EvLog > Actions > Locate All Devices using iCloud'. This will set the
    ...
    config_entry_id                 = None      # Has entry_id for iCloud3
    ...
    entity_reg_items_by_status      = {}  # Entity registry icloud3 devicename errors by (orphaned, disabled, deleted)
                                            # Set in entity_io.scan_entity_reg_for_icloud3_items)
    ...
    Sensors_by_devicename           = {}  # Sensor[devicename]_[sensor_name] objects
    Sensors_by_devicename_from_zone = {}  # Sensor[devicename]_[sensor_name]_[from_zone] objects
    Sensors_by_devicename_sensor    = {}  # Sensor[devicename_sensor_name] objects

    sensors_added_by_devicename     = {}  # Updated when a sensor is added in sensor.added_to_hass
    ...
    icloud3_reload_requested_secs   = 0         # Set to True when a reload is prpbable (enable sensor)
    is_ha_restart_needed            = False     # HA needs to be restarted
    ...
    is_log_level_debug               = True
    is_log_level_rawdata             = False
    is_log_level_rawdata_unfiltered  = False
    is_log_level_debug_restart       = None
    is_log_level_rawdata_restart     = None
    is_evlog_trk_monitors_displayed  = False
    is_evlog_startup_log_displayed   = False
    info_notification            = ''
    ha_notification              = {}
    trace_prefix                 = '_INIT_'
    ...
    is_waze_dist_method_used        = True
    is_force_icloud_update          = False
    ...
    is_gps_lat_long_displayed       = DEFAULT_GENERAL_CONF[CONF_DISPLAY_GPS_LAT_LONG]
    is_loc_centered_in_zone             = DEFAULT_GENERAL_CONF[CONF_CENTER_IN_ZONE]
    ...
    is_poor_gps_inzone_discarded    = DEFAULT_GENERAL_CONF[CONF_DISCARD_POOR_GPS_INZONE]
    is_dist_between_devices_calc    = DEFAULT_GENERAL_CONF[CONF_DISTANCE_BETWEEN_DEVICES]
    ...
    is_waze_paused_close_to_zone = False           # Close to home pauses Waze
    is_recalc_wazehist_time_dist = False     # Set in config_flow > Actions to schedule a db rebuild at midnight
