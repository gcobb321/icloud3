...
v2.2.1f
-------
1. Bug fix - Fixed an error introduced in v2.2.1e dealing with authentication error checking.
2. Parameter change - Changed 'dislay_zone_name:' to 'display_zone_fname' to match what iCloud3 was doing before v2.2.1e.
3. If the zone name is displayed, it will be reformatted before it is displayed. For example, 'the_shores' will be displayed as 'TheShores'.
